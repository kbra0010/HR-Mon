// ======================================================================
// HRMon.v generated from TopDesign.cysch
// 05/12/2021 at 10:01
...
module top ;
	...
	cy_psoc3_pins_v1_10
		...
		Seven_Segment
		 (.oe(tmpOE__Seven_Segment_net),
		  .y({Net_17, Net_16, Net_15, Net_14, Net_13, Net_12, Net_11}),
    ...
    Timer_v2_80_0 One_Hz_Timer (
        ...
        .tc(Net_46),
        .trigger(1'b1));
    defparam One_Hz_Timer.CaptureCount = 2;
    defparam One_Hz_Timer.CaptureCounterEnabled = 0;
    defparam One_Hz_Timer.DeviceFamily = "PSoC5";
    defparam One_Hz_Timer.InterruptOnCapture = 0;
    defparam One_Hz_Timer.InterruptOnTC = 0;
    defparam One_Hz_Timer.Resolution = 16;
    defparam One_Hz_Timer.SiliconRevision = "0";
