...
{
    uint8 staticBits = (Seven_Segment_DR & (uint8)(~Seven_Segment_MASK));
    Seven_Segment_DR = staticBits | ((uint8)(value << Seven_Segment_SHIFT) & Seven_Segment_MASK);
}
...
{
	CyPins_SetPinDriveMode(Seven_Segment_0, mode);
	CyPins_SetPinDriveMode(Seven_Segment_1, mode);
	CyPins_SetPinDriveMode(Seven_Segment_2, mode);
	CyPins_SetPinDriveMode(Seven_Segment_3, mode);
	CyPins_SetPinDriveMode(Seven_Segment_4, mode);
	CyPins_SetPinDriveMode(Seven_Segment_5, mode);
	CyPins_SetPinDriveMode(Seven_Segment_6, mode);
}
...
{
    return (Seven_Segment_PS & Seven_Segment_MASK) >> Seven_Segment_SHIFT;
}
...
{
    return (Seven_Segment_DR & Seven_Segment_MASK) >> Seven_Segment_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Seven_Segment_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Seven_Segment_0_INTR) != 0u) 
		{ 
			 Seven_Segment_0_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Seven_Segment_1_INTR) != 0u) 
		{ 
			 Seven_Segment_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Seven_Segment_2_INTR) != 0u) 
		{ 
			 Seven_Segment_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Seven_Segment_3_INTR) != 0u) 
		{ 
			 Seven_Segment_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Seven_Segment_4_INTR) != 0u) 
		{ 
			 Seven_Segment_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Seven_Segment_5_INTR) != 0u) 
		{ 
			 Seven_Segment_5_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Seven_Segment_6_INTR) != 0u) 
		{ 
			 Seven_Segment_6_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Seven_Segment_INTSTAT & Seven_Segment_MASK) >> Seven_Segment_SHIFT;
    }
